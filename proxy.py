...
with open("proxies.txt", 'w') as file:
        ...
        file.write(httpx.get(file.write(httpx.get("https://sheesh.rip/all.txt").text)
        file.write(httpx.get("http://alexa.lr2b.com/proxylist.txt").text)
        file.write(httpx.get(file.write(httpx.get("https://www.proxy-list.download/api/v1/get?type=socks4").text)
        file.write(httpx.get(file.write(httpx.get("https://www.proxy-list.download/api/v1/get?type=socks5").text)
        file.write(httpx.get(file.write(httpx.get("https://www.proxy-list.download/api/v1/get?type=http").text)
        ...
        "http://rootjazz.com/proxies/proxies.txt").text)
        ...
        file.write(httpx.get("https://www.proxydocker.com/en/proxylist/download?email=noshare&country=all&city=all&port=all&type=all&anonymity=all&state=all&need=all"
